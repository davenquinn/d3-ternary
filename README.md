...
[#](#baryCentricADoc) _barycentric_.**a**([_a_]) [<>](todo)
...
[#](#baryCentricBDoc) _barycentric_.**b**([_b_]) [<>](todo)
...
[#](#baryCentricCDoc) _barycentric_.**c**([_c_]) [<>](todo)
...
[#](#baryCentricConvertDoc) _barycentric_.**convert**(_data_) [<>](todo)
...
[#](#baryCentricInvertDoc) _barycentric_.**invert**(_coordinates_) [<>](todo)
...
[#](#baryCentricNormalizeDoc) _barycentric_.**normalize**(_ternaryData_) [<>](todo)

Computes normalized ternary values by summing and taking proportions of ternary data using the value accessors.

[#](#baryCentricVerticesDoc) _barycentric_.**vertices**([_vertices_]) [<>](todo)
...
[#](#densityPlotDensityDoc) _ternaryPlot_.**invert**(_coordinates_) [<>](todo)
...
[#](#tod) _ternaryPlot_.**convert**(_data_) [<>](todo)
...
[#](#ternaryPlotVerticesDoc) _ternaryPlot_.**vertices**(_vertices_) [<>](todo)

If _vertices_ is specified, removes the radius scale from _vertices_ and sets the vertices of the _barycentric()_ function passed to _ternaryPlot()_. If _vertices_ is not specified, return the current scaled vertices.

[#](#ternaryPlotRadiusDoc) _ternaryPlot_.**radius**([_radius_]) [<>](todo)
...
[#](#ternaryPlotDomainsDoc) _ternaryPlot_.**domains**([_domains_]) [<>](todo)
...
[#](#ternaryPlotLabelsDoc) _ternaryPlot_.**labels**([_labels_]) [<>](todo)
...
[#](#ternaryPlotLabelAnglesDoc) _ternaryPlot_.**labelAngles**([_angles_]) [<>](todo)
...
[#](#ternaryPlotLabelOffsetsDoc) _ternaryPlot_.**labelOffsets**([_offsets_]) [<>](todo)
...
[#](#ternaryPlotGridLineCountsDoc) _ternaryPlot_.**gridLineCounts**([_counts_]) [<>](todo)
...
[#](#ternaryPlotTickCountsDoc) _ternaryPlot_.**tickCounts**([_counts_]) [<>](todo)
...
[#](#ternaryPlotTickAnglesDoc) _ternaryPlot_.**tickAngles**([_angles_]) [<>](todo)
...
[#](#ternaryPlotTickAnchorsDoc) _ternaryPlot_.**tickAnchors**([_textAnchors_]) [<>](todo)
...
[#](#ternaryPlotTickSizesDoc) _ternaryPlot_.**tickSizes**([_sizes_]) [<>](todo)
...
[#](#ternaryPlotTickFormatDoc) _ternaryPlot_.**tickFormat**([_format_]) [<>](todo)
...
[#](#ternaryPlotTranslateDoc) _ternaryPlot_.**translate**([scale]) [<>](todo)
...
[#](#ternaryPlotScaleDoc) _ternaryPlot_.**scale**(_[scale]_) [<>](todo)
...
[#](#ternaryPlotGridLinesDoc) _ternaryPlot_.**gridLines**() [<>](todo)
...
[#](#ternaryPlotTicksDoc) _ternaryPlot_.**ticks**() [<>](todo)
...
[#](#ternaryPlotAxisLabelsDoc) _ternaryPlot_.**axisLabels**(_[{center: false}]_) [<>](todo)
...
[#](#ternaryPlotTransformDoc) _ternaryPlot_.**transform**() [<>](todo)
...
[#](#ternaryPlotReverseVerticesDoc) _ternaryPlot_.**reverseVertices**() [<>](todo)
...
[#](#ternaryPlotTransformFromDomainsDoc) _ternaryPlot_.**transformFromDomains**(_domains_) [<>](todo)
...
[#](#ternaryPlotDomainsFromVerticesDoc) _ternaryPlot_.**domainsFromVertices**() [<>](todo)
...
[#](#ternaryPlotSetDomainsDoc) _ternaryPlot_.**setDomains**(domains) [<>](todo)
